...
public class ReservasView extends JFrame {
	...
	private ReservasControllers ReservasControllers;
	...
	public ReservasView() {
		...
		super("Reserva");
		this.ReservasControllers = new ReservasControllers();
		...
		txtFechaEntrada.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				valorReserva(txtFechaEntrada, txtFechaSalida);
			}
		});
	...
	public void guardaReserva() {
		...
		Reserva reserva = new Reserva(java.sql.Date.valueOf(fechaIn),java.sql.Date.valueOf(fechaOut),txtValor.getText(), txtFormaPago.getSelectedItem().toString());
		ReservasControllers.guardar(reserva);
	...
	public void valorReserva(JDateChooser fechaIn, JDateChooser fechaOut) {
		
		
		if(fechaIn.getDate() != null && fechaOut.getDate() != null) {
			Calendar ida = fechaIn.getCalendar();
			Calendar vuelta = fechaOut.getCalendar();
			int dias = -1;
			int tasa = 1000;
			int valor;
			
			while(ida.before(vuelta) || ida.equals(vuelta)) {
				dias++;
				ida.add(Calendar.DATE, 1);
			}

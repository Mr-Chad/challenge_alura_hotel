...
public class RegistroHuesped extends JFrame {
	...
	int xMouse, yMouse;
	private HuespedesControllers HuesperdesControllers;
	...
	public RegistroHuesped(int idReserva) {
		...
		this.HuesperdesControllers = new HuespedesControllers();
	...
	public void guardarHuesped() {
		String nacimiento = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
		
		Huesped huesped = new Huesped(txtNombre.getText(), txtApellido.getText(), java.sql.Date.valueOf(nacimiento), txtNacionalidad.getSelectedItem().toString() ,txtTelefono.getText(), Integer.valueOf(txtNreserva.getText())  );
		
		HuesperdesControllers.guardar(huesped);
